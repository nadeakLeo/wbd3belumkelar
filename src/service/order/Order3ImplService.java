 ...
 * 
 */
@WebServiceClient(name = "Order3ImplService", targetNamespace = "http://order.service/", wsdlLocation = "http://localhost:8099/services/order3?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDER3IMPLSERVICE_QNAME = new QName("http://order.service/", "Order3ImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8099/services/order3?wsdl");
    ...
    public Order3 getOrder3ImplPort() {
        return super.getPort(new QName("http://order.service/", "Order3ImplPort"), Order3.class);
    }
    ...
    public Order3 getOrder3ImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://order.service/", "Order3ImplPort"), Order3.class, features);
    }
